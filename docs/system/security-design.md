...
| ------------------ | ---------------- | ----------------------------------------------------------- |
| `/`                | なし             | 公開（ランディングページ）                                  |
| `/apply`           | なし             | 公開（アカウント作成 + 利用申請）                           |
| `/login`           | なし             | 未認証のみ（認証済みは /admin へリダイレクト）              |
| `/consent`         | なし             | 認証済み + 未同意（招待経由ユーザー用）                    |
| `/terms`, `/privacy` | なし           | 公開                                                        |
| `/chat/**`         | `auth`           | 認証済み + グループ所属                                     |
| `/admin`           | `auth` + `admin` | 管理者 or 承認待ち申請あり（制限付き表示）                  |
