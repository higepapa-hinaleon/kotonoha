  ...
  <header class="sticky top-0 z-40 border-b border-gray-200 bg-white">
    <div class="flex h-14 items-center justify-between px-4">
      <div class="flex items-center gap-3">
        ...
        <NuxtLink :to="isAdmin ? '/admin' : '/chat'" class="text-lg font-bold text-primary-600">
          kotonoha AI Support
        </NuxtLink>
      </div>
      ...
      <div v-else class="relative flex items-center gap-2">
        ...
        >
          <div
            class="flex h-7 w-7 items-center justify-center rounded-full bg-primary-100 text-xs font-medium text-primary-700"
          >
